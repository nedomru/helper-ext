const URL_PATTERNS = {
    ...
    CLIENT_SESSION: 'db.ertelecom.ru/static_pages/private/wcc/client_session/?user_id',
    RADIUS_LOGIN: 'db.ertelecom.ru/cgi-bin/ppo/excells/radius_accounting_info.login_detail?id_session',
...
const initializeExtension = async () => {
    ...
    if (matchesUrlPattern(URL_PATTERNS.ARM_BASE) && !matchesUrlPattern(URL_PATTERNS.CHANGE_REQUEST)) {
        // Инициализация удаления вкладок договора
        const tabSettings = await browser.storage.sync.get(Object.keys(TABS_CONFIG));
